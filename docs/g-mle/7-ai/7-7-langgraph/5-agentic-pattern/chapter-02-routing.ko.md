...
- 섹션: `Chapter 2: Routing`
- 페이지 범위: `docs/agentic-design-patterns-toc.md`의 논리 페이지 30-42
- 추출 참고: Chapter 2는 PDF 페이지 인덱스 35, 파일 페이지 36에서 시작하고 Chapter 3는 PDF 페이지 인덱스 49, 파일 페이지 50에서 시작한다. 따라서 추출된 Chapter 2 범위는 PDF 인덱스 35-48, 파일 페이지 36-49, 챕터 내부 페이지 카운터 1-14로 보인다. 이는 TOC의 논리 범위 30-42가 13페이지인 점과 모호성이 있다.
