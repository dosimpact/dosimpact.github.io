...
- 머릿속 생각을 잘 메타인지하면 나의 의도가 담긴 '심상' 단계가 있다. 한국어로 전환하기 전에 머릿속에서 알 수 없는 무언가의 욕망이 먼저 끌어올라간다.  
...
- [ ] 영어에서 문장을 만들 때는 MPT Rule(Manner(방법) → Place(장소) → Time(시간) 순서 → 이유(Reason)) 순서로 부사를 붙이다.  
