...
- 대세 상승장 신호는 빌딩, 분양권, 재개발·재건축에서 먼저 나타날 것.  
...
📌 송희구 
- 하락장이 온다면? 25년 초 수준으로 하락할 것.  
- 한국은 일본처럼 LTV 100%가 아니라서 일본만큼의 부동산 버블은 아니다.  
대장 단지가 먼저 가격을 치고 올라가면, 그 주변 아파트 단지의 가격들이 올라간다.  
*그러나 나홀로 아파트나, 주상복합은 그 만큼 잘 따라가지 못한다.  
- 1, 일자리가 없는 지역, 2,교통이 불편한 지역 3,나홀로 아파트 4,인구가 빠르게 줄고 있는 지역 5,전세가율이 너무 높은 지역.     
