...
# NextJS Essential 1 - SSR  

- [NextJS Essential 1 - SSR](#nextjs-essential-1---ssr)
  - [AppRouter](#approuter)
    - [디렉터리 구조](#디렉터리-구조)
...
ref : Next.js 에센셜: Next.js 웹앱에서 Client Side Rendering을 추구하면 안되는걸까? > https://cat-minzzi.tistory.com/104
